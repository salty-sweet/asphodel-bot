            ...
            if (args[0] == "slash" || args[0] == "commands") {
                if (args[0] == "slash") {
                    response = new Discord.MessageEmbed()
                        ...
                        .setDescription(`**${client.user.username}**'s slash commands are instantly available when typing **\`/\`** into your chat box. Discord should tell you about the available commands!
                ...
                response = new Discord.MessageEmbed()
                    ...
                    .setDescription(`**${client.user.username}** supports both Slash commands and **\`${prefix}\`** commands!\nBecause of that, help comes in two parts!\n\u200B`)
